...
- Le funzioni **click_show_base(), click_hide(), click_show_toy(), click_show_metallic(), click_show_used() e click_show_enviroment()** hanno il solo scopo di ascoltare il click del pulsante e settare a true la variabile corrispondente consentendo l'avvio della procedura specificata precedentemente per visualizzare gli oggetti desiderati;
